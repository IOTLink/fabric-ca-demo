...
const (
	TxValidationCode_VALID                        TxValidationCode = 0 //交易有效
	TxValidationCode_NIL_ENVELOPE                 TxValidationCode = 1 //空背书 空信封
	TxValidationCode_BAD_PAYLOAD                  TxValidationCode = 2 //损坏的效载荷
	TxValidationCode_BAD_COMMON_HEADER            TxValidationCode = 3 //损坏头
	TxValidationCode_BAD_CREATOR_SIGNATURE        TxValidationCode = 4 //损坏的创作者签名
	TxValidationCode_INVALID_ENDORSER_TRANSACTION TxValidationCode = 5 //无效背书交易
	TxValidationCode_INVALID_CONFIG_TRANSACTION   TxValidationCode = 6 //无效配置交易
	TxValidationCode_UNSUPPORTED_TX_PAYLOAD       TxValidationCode = 7 //不支持的TX有效载荷
	TxValidationCode_BAD_PROPOSAL_TXID            TxValidationCode = 8 //损坏的提案交易id
	TxValidationCode_DUPLICATE_TXID               TxValidationCode = 9 //重复的交易id
	TxValidationCode_ENDORSEMENT_POLICY_FAILURE   TxValidationCode = 10 //背书策略失败
	TxValidationCode_MVCC_READ_CONFLICT           TxValidationCode = 11 //MVCC阅读冲突
	TxValidationCode_PHANTOM_READ_CONFLICT        TxValidationCode = 12 //幻影阅读冲突 脏读
	TxValidationCode_UNKNOWN_TX_TYPE              TxValidationCode = 13 //未知交易类型
	TxValidationCode_TARGET_CHAIN_NOT_FOUND       TxValidationCode = 14 //chiancode 未发现
	TxValidationCode_MARSHAL_TX_ERROR             TxValidationCode = 15 //原子交易失败
	TxValidationCode_NIL_TXACTION                 TxValidationCode = 16 //空交易触发
	TxValidationCode_EXPIRED_CHAINCODE            TxValidationCode = 17 //过期chaincode
	TxValidationCode_CHAINCODE_VERSION_CONFLICT   TxValidationCode = 18 //chaincode 版本冲突
	TxValidationCode_BAD_HEADER_EXTENSION         TxValidationCode = 19 //损坏的头扩张数据
	TxValidationCode_BAD_CHANNEL_HEADER           TxValidationCode = 20 //损坏的channel头数据
	TxValidationCode_BAD_RESPONSE_PAYLOAD         TxValidationCode = 21 //损坏的payload数据
	TxValidationCode_BAD_RWSET                    TxValidationCode = 22 //损坏的读写集合
	TxValidationCode_ILLEGAL_WRITESET             TxValidationCode = 23 //非法的wr iteset
	TxValidationCode_INVALID_OTHER_REASON         TxValidationCode = 255 //无效的其他冲突
)
