...
func CreateAndSendTransactionProposal(sender apitxn.ProposalSender, chainCodeID string,
	...
	for _, v := range transactionProposalResponses {
		...
		//logger.Debug("invoke Endorser '%s' returned ProposalResponse status:%v\n", v.Endorser, v.Status)
		logger.Info("transactionProposalResponses === ", v.Endorser, v.Status, v.ProposalResponse.Payload, string(v.ProposalResponse.Response.Payload), v.ProposalResponse.Response.Message)
	}
